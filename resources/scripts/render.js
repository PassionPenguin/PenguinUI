...
(() => {
    document.documentElement.appendNewChild({
        type: "style",
        innerHTML: ".pg-render-code-icon .mi {font-size: 16px;margin-right:3px;}.pg-render-code-icon * {vertical-align: middle;color:#666;} .pg-render-code-icon .text-description{font-size:13px;}.hljs{display:block;overflow-x:auto;padding:.5em;color:#383a42;border-radius:3px;font:14px/21px 'Jetbrains Mono', monospace;}.hljs-comment,.hljs-quote{color:#a0a1a7;font-style:italic}.hljs-doctag,.hljs-formula,.hljs-keyword{color:#a626a4}.hljs-deletion,.hljs-name,.hljs-section,.hljs-selector-tag,.hljs-subst{color:rgb(228,86,74)}.hljs-literal{color:#0184bb}.hljs-addition,.hljs-attribute,.hljs-meta-string,.hljs-regexp,.hljs-string{color:#50a14f}.hljs-built_in,.hljs-class .hljs-title{color:#c18401}.hljs-attr,.hljs-number,.hljs-selector-attr,.hljs-selector-class,.hljs-selector-pseudo,.hljs-template-variable,.hljs-type,.hljs-variable{color:rgb(193,133,6);}.hljs-bullet,.hljs-link,.hljs-meta,.hljs-selector-id,.hljs-symbol,.hljs-title{color:#4078f2}.hljs-emphasis{font-style:italic}.hljs-strong{font-weight:700}.hljs-link{text-decoration:underline}.renderCode .collapseCode{width:80%;margin:0 auto}.renderCode .rendered{width:50%;margin:0 auto;padding:6px 25% 12px 25%;border-bottom: 1px solid #efefef;}.pg-render-code{width:fit-content;margin:0 auto;}.renderCode{border: 1px solid #efefef;border-radius: 6px;}"
    })
        ...
        if (changedInf.length > 0)
            changedInf.forEach(detail => {
                if (detail[0].classList.contains("renderCode")) {
                    ...
                    $(`#${detail[0].id} code`)[0].innerHTML = val.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/"/g, "&quot;");
                    hljs.highlightBlock($(`#${detail[0].id} code`)[0]);
                    detail[0].children.last().appendNewChild({
                        type: "div",
